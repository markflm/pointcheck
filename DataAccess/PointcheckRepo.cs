...
namespace pointcheck_api.DataAccess
{
    ...
    public class PointcheckRepo : IPointcheckRepo
    {
        ...
        {
            var returnedResult = new MatchedGamesResult{playerOneName = "Kifflom", playerOneKd = 300, playerOneWinPercent = 1,
            playerOneHeadToHeadKd = 500, playerOneHeadToHeadWinPercent = 1,
            playerTwoName = "Kezug", playerTwoKd =  -1, playerTwoWinPercent = .99,  playerTwoHeadToHeadKd = -25, playerTwoHeadToHeadWinPercent = .5,
             MatchedGames = new List<Game>{
                 new Game{gameID=100, map="Guardian", gametype="CTF 3Flag", gamedate = new DateTime(2010, 2, 2)},
